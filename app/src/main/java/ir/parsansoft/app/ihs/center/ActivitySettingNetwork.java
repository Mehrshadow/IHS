...
import ir.parsansoft.app.ihs.center.AllViews.CO_d_simple_edit_text;
...
public class ActivitySettingNetwork extends ActivitySetting {
    ...
    ArrayList<WifiClass> wifiList          = new ArrayList<WifiClass>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (G.setting.languageID == 1 || G.setting.languageID == 4)
            ...
            setContentView(R.layout.f_setting_network_rtl);
        changeSlidebarImage(11);
        fo = new CO_f_setting_network(this);
        translateForm();
        new DialogClass(this).showOk(G.T.getSentence(760), G.T.getSentence(765));
        ...
        G.HANDLER.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                dlg.showOk(G.T.getSentence(725), G.T.getSentence(765));
            }
        }, 500);
    }
    ...
    private void connectToNetwork(final WifiClass wifi) {
        ...
        if (wifi.type.contains("WPA")) {
            ...
            final CO_d_simple_edit_text dlg = new CO_d_simple_edit_text(dialog);
            ...
            dlg.btnPositive.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    dialog.dismiss();
                    final MyWiFiManager myWM = new MyWiFiManager();
