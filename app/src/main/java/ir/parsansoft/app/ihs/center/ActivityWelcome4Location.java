...
public class ActivityWelcome4Location extends ActivityWizard implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setOnBackListenner(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                if (!isBusy) {
                    isBusy = true;
                    startActivity(new Intent(G.currentActivity, ActivityWelcome3Network.class));
        ...
        setOnNextListenner(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                if (!isBusy) {
                    isBusy = true;
                    startActivity(new Intent(G.currentActivity, ActivityWelcome5DateandTime.class));
                    Animation.doAnimation(Animation_Types.FADE);
                    finish();
                }
            }
    ...
    private void initializeForm() {
        ...
        if (G.setting.gPSLat == 0 || G.setting.gPSLon == 0) {
            G.setting.gPSLat = 29.646332;
            G.setting.gPSLon = 52.493349;
        }
        radius = 1;
    ...
    private void loadMap() {
        ...
        fo.webMap.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                fo.webMap.loadUrl("javascript:setPosition('" + fo.edtLat.getText().toString() + "','" + fo.edtLong.getText().toString() + "','" + 1 + "')");
                /***************************************** Mobarraei ************************************/
            }
