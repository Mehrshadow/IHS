...
public class AllViews {
    ...
    public static final class CO_d_section_Select_Place {
        ...
        public CO_d_section_Select_Place(Dialog dlg) {
            layOptions = (LinearLayout) dlg.findViewById(R.id.layOptions);
            listView1 = (ListView) dlg.findViewById(R.id.lstLanguage);
            scrollView1 = (ScrollView) dlg.findViewById(R.id.scrollView1);
            laySection = (LinearLayout) dlg.findViewById(R.id.laySection);
...
//                chkBoxPort5, chkBoxPort6, chkBoxPort7, chkBoxPort8, chkBoxPort9, chkBoxPort10;
        ...
        public CO_d_section_add_node_Sensor(Context context) {
            ...
            btnCancel = (Button) activity.findViewById(R.id.btnCancel);
            btnBack = (Button) activity.findViewById(R.id.btnBack);
//            chkBoxPort1 = (CheckBox)activity.findViewById(R.sensorNodeId.chkBoxPort1);
//            chkBoxPort2 = (CheckBox)activity.findViewById(R.sensorNodeId.chkBoxPort2);
//            chkBoxPort3 = (CheckBox)activity.findViewById(R.sensorNodeId.chkBoxPort3);
//            chkBoxPort4 = (CheckBox)activity.findViewById(R.sensorNodeId.chkBoxPort4);
//            chkBoxPort5 = (CheckBox)activity.findViewById(R.sensorNodeId.chkBoxPort5);
//            chkBoxPort6 = (CheckBox)activity.findViewById(R.sensorNodeId.chkBoxPort6);
//            chkBoxPort7 = (CheckBox)activity.findViewById(R.sensorNodeId.chkBoxPort7);
//            chkBoxPort8 = (CheckBox)activity.findViewById(R.sensorNodeId.chkBoxPort8);
//            chkBoxPort9 = (CheckBox)activity.findViewById(R.sensorNodeId.chkBoxPort9);
//            chkBoxPort10 = (CheckBox)activity.findViewById(R.sensorNodeId.chkBoxPort10);
...
//            listMarket = (HorizontialListView) activity.findViewById(R.sensorNodeId.lstMarket);
            intializeVariables();
...
//            lstMobiles = (ListView) dlg.findViewById(R.sensorNodeId.lstMobiles);
...
//            lstMobiles = (ListView) view.findViewById(R.sensorNodeId.lstMobiles);
    ...
    public static final class CO_f_senario_w10 {
        ...
        public CO_f_senario_w10(Context context) {
            ...
            layNavigation = (LinearLayout) activity.findViewById(R.id.layNavigation);
            btnCancel = (Button) activity.findViewById(R.id.btnCancel);
            //TextView05 = (TextView) activity.findViewById(R.sensorNodeId.TextView05);
            btnBack = (Button) activity.findViewById(R.id.btnBack);
        ...
        public CO_f_senario_w10(Dialog dlg) {
            ...
            layNavigation = (LinearLayout) dlg.findViewById(R.id.layNavigation);
            btnCancel = (Button) dlg.findViewById(R.id.btnCancel);
            //TextView05 = (TextView) dlg.findViewById(R.sensorNodeId.TextView05);
            btnBack = (Button) dlg.findViewById(R.id.btnBack);
        ...
        public CO_f_senario_w10(View view) {
            ...
            layNavigation = (LinearLayout) view.findViewById(R.id.layNavigation);
            btnCancel = (Button) view.findViewById(R.id.btnCancel);
            //TextView05 = (TextView) view.findViewById(R.sensorNodeId.TextView05);
            btnBack = (Button) view.findViewById(R.id.btnBack);
...
//            scrollView1 = (ScrollView) activity.findViewById(R.sensorNodeId.scrollView1);
            LinearLayout02 = (LinearLayout) activity.findViewById(R.id.LinearLayout02);
//            comNodeSelector1 = (ir.parsansoft.app.ihs.center.components.ComNodeSelector) activity.findViewById(R.sensorNodeId.comNodeSelector1);
//            layPerOperandValueRange = (LinearLayout) activity.findViewById(R.sensorNodeId.layPerOperandValueRange);
//            TextView07 = (TextView) activity.findViewById(R.sensorNodeId.TextView07);
//            spnLogicalSign = (Spinner) activity.findViewById(R.sensorNodeId.spnLogicalSign);
//            edtLogicalValue = (EditText) activity.findViewById(R.sensorNodeId.edtLogicalValue);
//            layPerOperandValueSelective = (LinearLayout) activity.findViewById(R.sensorNodeId.layPerOperandValueSelective);
//            TextView04 = (TextView) activity.findViewById(R.sensorNodeId.TextView04);
//            spnSelectiveValue = (Spinner) activity.findViewById(R.sensorNodeId.spnSelectiveValue);
            btnAdd = (Button) activity.findViewById(R.id.btnAdd);
            layNavigation = (LinearLayout) activity.findViewById(R.id.layNavigation);
            btnCancel = (Button) activity.findViewById(R.id.btnCancel);
            //TextView05 = (TextView) activity.findViewById(R.sensorNodeId.TextView05);
...
//            scrollView1 = (ScrollView) dlg.findViewById(R.sensorNodeId.scrollView1);
            LinearLayout02 = (LinearLayout) dlg.findViewById(R.id.LinearLayout02);
//            comNodeSelector1 = (ir.parsansoft.app.ihs.center.components.ComNodeSelector) dlg.findViewById(R.sensorNodeId.comNodeSelector1);
//            layPerOperandValueRange = (LinearLayout) dlg.findViewById(R.sensorNodeId.layPerOperandValueRange);
//            TextView07 = (TextView) dlg.findViewById(R.sensorNodeId.TextView07);
//            spnLogicalSign = (Spinner) dlg.findViewById(R.sensorNodeId.spnLogicalSign);
//            edtLogicalValue = (EditText) dlg.findViewById(R.sensorNodeId.edtLogicalValue);
//            layPerOperandValueSelective = (LinearLayout) dlg.findViewById(R.sensorNodeId.layPerOperandValueSelective);
//            TextView04 = (TextView) dlg.findViewById(R.sensorNodeId.TextView04);
//            spnSelectiveValue = (Spinner) dlg.findViewById(R.sensorNodeId.spnSelectiveValue);
            btnAdd = (Button) dlg.findViewById(R.id.btnAdd);
            layNavigation = (LinearLayout) dlg.findViewById(R.id.layNavigation);
            btnCancel = (Button) dlg.findViewById(R.id.btnCancel);
            //TextView05 = (TextView) dlg.findViewById(R.sensorNodeId.TextView05);
...
//            scrollView1 = (ScrollView) view.findViewById(R.sensorNodeId.scrollView1);
            LinearLayout02 = (LinearLayout) view.findViewById(R.id.LinearLayout02);
//            comNodeSelector1 = (ir.parsansoft.app.ihs.center.components.ComNodeSelector) view.findViewById(R.sensorNodeId.comNodeSelector1);
//            layPerOperandValueRange = (LinearLayout) view.findViewById(R.sensorNodeId.layPerOperandValueRange);
//            TextView07 = (TextView) view.findViewById(R.sensorNodeId.TextView07);
//            spnLogicalSign = (Spinner) view.findViewById(R.sensorNodeId.spnLogicalSign);
//            edtLogicalValue = (EditText) view.findViewById(R.sensorNodeId.edtLogicalValue);
//            layPerOperandValueSelective = (LinearLayout) view.findViewById(R.sensorNodeId.layPerOperandValueSelective);
//            TextView04 = (TextView) view.findViewById(R.sensorNodeId.TextView04);
//            spnSelectiveValue = (Spinner) view.findViewById(R.sensorNodeId.spnSelectiveValue);
            btnAdd = (Button) view.findViewById(R.id.btnAdd);
            layNavigation = (LinearLayout) view.findViewById(R.id.layNavigation);
            btnCancel = (Button) view.findViewById(R.id.btnCancel);
            //TextView05 = (TextView) view.findViewById(R.sensorNodeId.TextView05);
...
//            layPerOperandValueRange = (LinearLayout) activity.findViewById(R.sensorNodeId.layPerOperandValueRange);
            layOptions = (LinearLayout) activity.findViewById(R.id.layOptions);
//            layParameters = (LinearLayout) activity.findViewById(R.sensorNodeId.layParameters);
//            txtNumericValue = (TextView) activity.findViewById(R.sensorNodeId.txtNumericValue);
//            edtLogicalValue = (EditText) activity.findViewById(R.sensorNodeId.edtLogicalValue);
//            layPerOperandValueSelective = (LinearLayout) activity.findViewById(R.sensorNodeId.layPerOperandValueSelective);
//            txtSelectiveValue = (TextView) activity.findViewById(R.sensorNodeId.txtSelectiveValue);
//            spnSelectiveValue = (Spinner) activity.findViewById(R.sensorNodeId.spnSelectiveValue);
//            layMainReverse = (LinearLayout) activity.findViewById(R.sensorNodeId.layMainReverse);
//            chkReverse = (CheckBox) activity.findViewById(R.sensorNodeId.chkReverse);
//            layReverse = (LinearLayout) activity.findViewById(R.sensorNodeId.layReverse);
//            txtReverseTime = (TextView) activity.findViewById(R.sensorNodeId.txtReverseTime);
//            edtReverseTime = (EditText) activity.findViewById(R.sensorNodeId.edtReverseTime);
//            spnTimeUnit = (Spinner) activity.findViewById(R.sensorNodeId.spnTimeUnit);
            btnAdd = (Button) activity.findViewById(R.id.btnAdd);
            layNavigation = (LinearLayout) activity.findViewById(R.id.layNavigation);
            btnClose = (Button) activity.findViewById(btnCancel);
            textView1 = (TextView) activity.findViewById(R.id.txtLanguage);
...
//            layPerOperandValueRange = (LinearLayout) dlg.findViewById(R.sensorNodeId.layPerOperandValueRange);
            layOptions = (LinearLayout) dlg.findViewById(R.id.layOptions);
//            layParameters = (LinearLayout) dlg.findViewById(R.sensorNodeId.layParameters);
//            txtNumericValue = (TextView) dlg.findViewById(R.sensorNodeId.txtNumericValue);
//            edtLogicalValue = (EditText) dlg.findViewById(R.sensorNodeId.edtLogicalValue);
//            layPerOperandValueSelective = (LinearLayout) dlg.findViewById(R.sensorNodeId.layPerOperandValueSelective);
//            txtSelectiveValue = (TextView) dlg.findViewById(R.sensorNodeId.txtSelectiveValue);
//            spnSelectiveValue = (Spinner) dlg.findViewById(R.sensorNodeId.spnSelectiveValue);
//            layMainReverse = (LinearLayout) dlg.findViewById(R.sensorNodeId.layMainReverse);
//            chkReverse = (CheckBox) dlg.findViewById(R.sensorNodeId.chkReverse);
//            layReverse = (LinearLayout) dlg.findViewById(R.sensorNodeId.layReverse);
//            txtReverseTime = (TextView) dlg.findViewById(R.sensorNodeId.txtReverseTime);
//            edtReverseTime = (EditText) dlg.findViewById(R.sensorNodeId.edtReverseTime);
//            spnTimeUnit = (Spinner) dlg.findViewById(R.sensorNodeId.spnTimeUnit);
            btnAdd = (Button) dlg.findViewById(R.id.btnAdd);
            layNavigation = (LinearLayout) dlg.findViewById(R.id.layNavigation);
            btnClose = (Button) dlg.findViewById(btnCancel);
            textView1 = (TextView) dlg.findViewById(R.id.txtLanguage);
...
//            layPerOperandValueRange = (LinearLayout) view.findViewById(R.sensorNodeId.layPerOperandValueRange);
            layOptions = (LinearLayout) view.findViewById(R.id.layOptions);
//            layParameters = (LinearLayout) view.findViewById(R.sensorNodeId.layParameters);
//            txtNumericValue = (TextView) view.findViewById(R.sensorNodeId.txtNumericValue);
//            edtLogicalValue = (EditText) view.findViewById(R.sensorNodeId.edtLogicalValue);
//            layPerOperandValueSelective = (LinearLayout) view.findViewById(R.sensorNodeId.layPerOperandValueSelective);
//            txtSelectiveValue = (TextView) view.findViewById(R.sensorNodeId.txtSelectiveValue);
//            spnSelectiveValue = (Spinner) view.findViewById(R.sensorNodeId.spnSelectiveValue);
//            layMainReverse = (LinearLayout) view.findViewById(R.sensorNodeId.layMainReverse);
//            chkReverse = (CheckBox) view.findViewById(R.sensorNodeId.chkReverse);
//            layReverse = (LinearLayout) view.findViewById(R.sensorNodeId.layReverse);
//            txtReverseTime = (TextView) view.findViewById(R.sensorNodeId.txtReverseTime);
//            edtReverseTime = (EditText) view.findViewById(R.sensorNodeId.edtReverseTime);
//            spnTimeUnit = (Spinner) view.findViewById(R.sensorNodeId.spnTimeUnit);
            btnAdd = (Button) view.findViewById(R.id.btnAdd);
            layNavigation = (LinearLayout) view.findViewById(R.id.layNavigation);
            btnClose = (Button) view.findViewById(btnCancel);
            textView1 = (TextView) view.findViewById(R.id.txtLanguage);
...
//        public TextView txtKey3;
        ...
        public CO_l_node_IoModule(Context context) {
            Activity activity = (Activity) context;
//            layKey1 = (LinearLayout) activity.findViewById(R.deviceNodeId.layKey1);
//            imgKey1 = (ImageView) activity.findViewById(R.deviceNodeId.imgKey1);
//            txtKey1 = (TextView) activity.findViewById(R.deviceNodeId.txtKey1);
//            layKey2 = (LinearLayout) activity.findViewById(R.deviceNodeId.layKey2);
//            imgKey2 = (ImageView) activity.findViewById(R.deviceNodeId.imgKey2);
//            txtKey2 = (TextView) activity.findViewById(R.deviceNodeId.txtKey2);
//            layKey3 = (LinearLayout) activity.findViewById(R.deviceNodeId.layKey3);
//            imgKey3 = (ImageView) activity.findViewById(R.deviceNodeId.imgKey3);
//            txtKey3 = (TextView) activity.findViewById(R.deviceNodeId.txtKey3);
            laySetting = (LinearLayout) activity.findViewById(R.id.laySetting);
            prgDoOperation = (ProgressBar) activity.findViewById(R.id.prgDoOperation);
            txtNodeName = (TextView) activity.findViewById(R.id.txtNodeName);
            imgbtnEdit = (ImageView) activity.findViewById(R.id.imgbtnEdit);
...
//            layKey1 = (LinearLayout) dlg.findViewById(R.deviceNodeId.layKey1);
//            imgKey1 = (ImageView) dlg.findViewById(R.deviceNodeId.imgKey1);
//            txtKey1 = (TextView) dlg.findViewById(R.deviceNodeId.txtKey1);
//            layKey2 = (LinearLayout) dlg.findViewById(R.deviceNodeId.layKey2);
//            imgKey2 = (ImageView) dlg.findViewById(R.deviceNodeId.imgKey2);
//            txtKey2 = (TextView) dlg.findViewById(R.deviceNodeId.txtKey2);
//            layKey3 = (LinearLayout) dlg.findViewById(R.deviceNodeId.layKey3);
//            imgKey3 = (ImageView) dlg.findViewById(R.deviceNodeId.imgKey3);
//            txtKey3 = (TextView) dlg.findViewById(R.deviceNodeId.txtKey3);
            laySetting = (LinearLayout) dlg.findViewById(R.id.laySetting);
            prgDoOperation = (ProgressBar) dlg.findViewById(R.id.prgDoOperation);
            txtNodeName = (TextView) dlg.findViewById(R.id.txtNodeName);
            imgbtnEdit = (ImageView) dlg.findViewById(R.id.imgbtnEdit);
...
//            layKey1 = (LinearLayout) view.findViewById(R.deviceNodeId.layKey1);
//            imgKey1 = (ImageView) view.findViewById(R.deviceNodeId.imgKey1);
//            txtKey1 = (TextView) view.findViewById(R.deviceNodeId.txtKey1);
//            layKey2 = (LinearLayout) view.findViewById(R.deviceNodeId.layKey2);
//            imgKey2 = (ImageView) view.findViewById(R.deviceNodeId.imgKey2);
//            txtKey2 = (TextView) view.findViewById(R.deviceNodeId.txtKey2);
//            layKey3 = (LinearLayout) view.findViewById(R.deviceNodeId.layKey3);
//            imgKey3 = (ImageView) view.findViewById(R.deviceNodeId.imgKey3);
//            txtKey3 = (TextView) view.findViewById(R.deviceNodeId.txtKey3);
            laySetting = (LinearLayout) view.findViewById(R.id.laySetting);
            prgDoOperation = (ProgressBar) view.findViewById(R.id.prgDoOperation);
            txtNodeName = (TextView) view.findViewById(R.id.txtNodeName);
            imgbtnEdit = (ImageView) view.findViewById(R.id.imgbtnEdit);
...
//            btnOK.setText(G.T.getSentence(101));
    ...
    public static final class CO_d_setting_user_access {
        ...
        public CO_d_setting_user_access(Context context) {
            ...
            layNavigation = (LinearLayout) activity.findViewById(R.id.layNavigation);
//            btnCancel = (Button) activity.findViewById(R.sensorNodeId.btnCancel);
            txtLanguage = (TextView) activity.findViewById(R.id.txtLanguage);
